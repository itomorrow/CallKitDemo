...
@interface AudioPlayer ()<GCDAsyncSocketDelegate>{
    pthread_mutex_t     _lock;
}

@property (nonatomic, assign) _Nonnull id <AudioPlayerDelegate> delegate;
...
- (void) socketDidDisconnect:(GCDAsyncSocket *)sock withError:(NSError *)err {
    ...
    //[self stopPlay];
    self.isRunning = NO;
    [self.delegate audioPlayerStop:self];
}
